...
# Return a field from a keyed list
proc twapi::kl_get {kl field} {
    foreach {fld val} $kl {
...
proc twapi::kl_get_default {kl field default} {
    foreach {fld val} $kl {
        if {[string equal $fld $field]} {
            return $val
        }
...
# time
proc twapi::large_system_time_to_secs {ns100 {fraction false}} {
    ...
    if {0} {
        ...
        if {$fraction} {
            append secs_since_1970 .[string range $ns100_since_1970 end-6 end]
        }
    }
