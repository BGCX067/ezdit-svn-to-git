...
proc twapi::get_desktop_wallpaper {} {
    set mem [malloc [expr 2*2048]];    # Unicode
    try {
        SystemParametersInfo 0x73 2048 $mem 0
        return [Twapi_ReadMemoryUnicode $mem 0]
    } finally {
        free $mem
    }
}
...
proc twapi::get_desktop_workarea {} {
    set rect [new_RECT]
    try {
        SystemParametersInfo 0x30 0 $rect 0
        return [list [$rect cget -left] [$rect cget -top] \
                    [$rect cget -right] [$rect cget -bottom]]
    } finally {
        $rect -delete
    }
}
...
proc twapi::screensaver_enabled {} {
    set mem [malloc 4]
    try {
        SystemParametersInfo 0x10 4 $mem 0
        binary scan [Twapi_ReadMemoryBinary $mem 0 4] i enabled
    } finally {
        free $mem
    }
    return $enabled
...
# Check if screen saver is enabled
proc twapi::enable_screensaver {x} {
    SystemParametersInfo 0x11 1 NULL $x
}

# Check if screen saver is enabled
proc twapi::disable_screensaver {x} {
    SystemParametersInfo 0x11 0 NULL $x
}

# Check if screen saver is running
proc twapi::screensaver_running {} {
    set mem [malloc 4]
    try {
        SystemParametersInfo 0x72 4 $mem 0
        binary scan [Twapi_ReadMemoryBinary $mem 0 4] i running
    } finally {
        free $mem
    }
    return $running
...
proc twapi::begin_screensaver {x} {
    SystemParametersInfo 0x61 1 NULL $x
}

# Get the screensaver timeout
proc twapi::get_screensaver_timeout {} {
    set mem [malloc 4]
    try {
        SystemParametersInfo 0xe 4 $mem 0
        binary scan [Twapi_ReadMemoryBinary $mem 0 4] i timeout
    } finally {
        free $mem
    }
    return $timeout
...
#
# Start the screensaver
proc twapi::set_screensaver_timeout {timeout x} {
    SystemParametersInfo 0xf $timeout NULL $x
}
