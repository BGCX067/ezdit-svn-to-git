...
::oo::class create $::twidget::Priv(prefix)::editor {
	...
	method goto_dialog {} {
		set dlg [::dApp::editor::gotobox new [my cget -frame].goto [self object]]
		$dlg show
		$dlg destroy	
	}	
...
oo::class create ::dApp::editor::gotobox {
...
::oo::class create $::twidget::Priv(prefix)::editor::searchbox {
	...
	method find_all {} {
		...
		set cut [$editor search $opts(-findText) -all 1]		
	...
	method replace_all {} {
		...
		set cut [$editor search $opts(-findText) -all 1 -replace $opts(-replaceText)]		
